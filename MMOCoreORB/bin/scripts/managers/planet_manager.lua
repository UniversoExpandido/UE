...
--		{"exp_tan_downed_ship",3293,-1324,0,30,141}, -- Cambiada por una de Kaas
		{"exp_tan_mine",-2609,-1305,0,30,142},
		{"exp_tan_hexfarms",-3002,-103,0,30,143},
--		{"exp_tan_great_herd",5537,-4958,0,30,144}, Cambiada por una de Jakku
...
jakku = {
	...
	{name = "Cratertown", x = 4223, z = 9.75, y = -5142, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
		...
		badgeAreas = {
	--			{"jakku_arena",4223,-5140,0,30,159},
				{"rey_jakku_poi",5000,-5560,0,30,162},
				{"jakku_battle",-5907,-5521,0,30,144},
		},
		planetObjects = {}
	}
...
moraband = {
  ...
  planetTravelPoints = {
    ...
    badgeAreas = {
			{"valley_korriban",-1300,-992,0,70,149},
		},
...
hutta = {
  ...
  planetTravelPoints = {
    ...
    badgeAreas = {
			{"bilbousa_palace",-767,1412,0,20,155},
		},
}
...
--    {name = "a Smuggler Outpost", x = 2852, z = 125, y = 3896, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1}, -- Aqui no hay nada en el mapa
    ...
    badgeAreas = {
			{"kaas_city",-6170,2688,0,30,151},
			{"vitiate_tomb",6011,-1142,0,20,141},
		},
}
...
---- nuevas ----
    ...
    badgeAreas = {
		  {"commerce_district_coruscant",-1844,-146,0,20,153},
		},
}
