...
/*
	...
	*/// ESPAÑOL:  Los de arriba son los predeterminados de Mod The Galaxy.
		...
		SHIPOPERATIONS           = 0x40000000,
		SHIPGUNNER               = 0x80000000,
		MINDTRICK								 = 0x100000000
	};

	static const uint64 SHIPINTERIOR = 1ull << 35;
	static const uint64	PILOTINGPOBSHIP = 1ull << 36;
