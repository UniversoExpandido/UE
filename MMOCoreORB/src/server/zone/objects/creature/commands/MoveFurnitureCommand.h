...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
		...
		if (!checkInvalidLocomotions(creature))
			...
			////////////////////////
	////		ManagedReference<PlayerObject*> ghost = creature->getPlayerObject(); /// Si Developer >>> No usar esto aqui
		...
		if (!creature->hasSkill("admin_server_admin_01"))  { //// Español: Inicio de Restriccion Developer
	...
	} ////  Español: Fin de Restriccion Developer
	...
	///// Lanza mensaje de error ////
	    creature->sendSystemMessage("@player_structure:format_movefurniture_distance");
			//////
			return INVALIDPARAMETERS;
		}
